...
import { Loader2, Search, Package, Truck, Calendar, User, Building2, Globe, ArrowRight, MapPin } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-600 mt-1">Manage and track your assigned orders</p>
          </div>
        ...
        {loading ? (
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-none shadow-lg rounded-2xl">
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-xl text-slate-600 mb-4">No orders assigned yet</p>
              <p className="text-slate-500 text-center max-w-md">
                You will see your assigned orders here once they are assigned to you by exporters.
              </p>
            </CardContent>
          </Card>
        ) : (
                  ...
                  <CardTitle className="flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-500">Assigned on {formatDate(order.createdAt)}</p>
                      </div>
                    </div>
                    <span className={`px-4 py-1.5 rounded-full text-sm font-medium ${getStatusBadgeClass(order.status)}`}>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-slate-50 rounded-xl">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <h3 className="text-sm font-medium text-slate-700">Exporter Information</h3>
                        </div>
                        <p className="text-sm text-slate-900 font-medium">{order.exporter?.name}</p>
                      ...
                      <div className="p-4 bg-slate-50 rounded-xl">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <h3 className="text-sm font-medium text-slate-700">Buyer Information</h3>
                        </div>
                        <p className="text-sm text-slate-900 font-medium">{order.buyer?.name}</p>
                      ...
                      {order.shippingAddress && (
                        <div className="p-4 bg-slate-50 rounded-xl">
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="text-sm font-medium text-slate-700">Delivery Address</h3>
                          </div>
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex flex-wrap gap-3">
                      ...
                      <Button
                        ...
                        className="bg-purple-600 hover:bg-purple-700 text-white shadow-sm hover:shadow-md transition-all duration-300"
                      >
                      ...
                      <Button
                        onClick={() => handleStatusUpdate(order._id, "Delayed")}
                        disabled={order.status === "Delayed"}
